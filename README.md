This repository contains some basic examples of using Vala and GTK+ 3. Each example tries to showcase some use of the widget in an easy-to-understand form.
